...
class Decoder(nn.Module):
    def __init__(self, hparams):
        ...
        self.speaker_embedd_dim = hparams.speaker_embedding_size
    ...
    def forward(self, memory, speaker_embeddings, decoder_inputs, memory_lengths):
...
class Tacotron2(nn.Module):
    ...
    def parse_batch(self, batch):
        text_padded, input_lengths, mel_padded, gate_padded, \
            output_lengths, speaker_embeddings = batch
        ...
        return (
            (text_padded, input_lengths, mel_padded, max_len, output_lengths, speaker_embeddings),
    ...
    def forward(self, inputs):
        ...
        # encoder_cond_outputs = torch.cat([encoder_outputs, speaker_embeddings.transpose(1,2)], dim=-1)
